                ...
                <form action="{{ route('roles.update', $role->id) }}" method="POST" class="p-4">
                    ...
                    <div class="flex gap-6 bg-white mb-6 px-6 py-4">
                        ...
                        <div class="ml-3 role-management-checkbox">
                            <input id="permission{{$permission->id}}"  onclick="checksinglepermission('role-management-checkbox','management')" name="permissions[]" value="{{$permission->id}}" @if(in_array($permission->id, $data)) checked @endif type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
